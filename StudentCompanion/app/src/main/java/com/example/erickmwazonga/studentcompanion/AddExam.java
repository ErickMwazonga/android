...
public class AddExam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        description = (EditText) findViewById(R.id.examDescription);
        venue = (EditText) findViewById(R.id.examVenue);
        date = (TextView) findViewById(R.id.examDate);
...
//        textViewExamTime.setTextColor(Color.RED);
...
//        textViewExamTime.setTextColor(Color.RED);
    ...
    public static class TimePickerFragment extends DialogFragment
        ...
        public void onTimeSet(TimePicker timePicker, int hourOfDay, int minute) {
            TextView textview = (TextView) getActivity().findViewById(R.id.examTime);
    ...
    public static class DatePickerFragment extends DialogFragment
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) {
            TextView textview = (TextView) getActivity().findViewById(R.id.examDate);
    ...
    public void saveExam(View view) {
        if (name.getText().toString().isEmpty()) {
            ...
            String examDescription = description.getText().toString();
            String examVenue = venue.getText().toString();
            String examDate = date.getText().toString();
            ...
            studentDBHelper.addExam(examName, examDescription, examVenue, examDate, examTime, sqLiteDatabase);
    ...
    public void showNotification() {
        NotificationCompat.Builder builder = new
                ...
                .setContentText("Date :" + date.getText().toString() + "       Time :" + time.getText().toString() + "     Prepare well before the Exam")
                .setTicker("Student Companion | Exams")
                .setSmallIcon(R.drawable.stasks);

        Intent moreInfoIntent = new Intent(this, Schedule.class);
        moreInfoIntent.putExtra("Exams", 1);
